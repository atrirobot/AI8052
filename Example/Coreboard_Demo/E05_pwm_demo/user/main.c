...
#define PWM_CH4                 (PWMB_CH4_P77)

#define PWM_CH5                 (PWMD_CH1_PB4)
#define PWM_CH6                 (PWMD_CH2_PB5)
#define PWM_CH7                 (PWMD_CH3_PB6)
#define PWM_CH8                 (PWMD_CH4_PB7)

int16 duty = 0;
uint8 channel_index = 0;
pwm_channel_enum channel_list[CHANNEL_NUMBER] = {PWM_CH1, PWM_CH2, PWM_CH3, PWM_CH4, PWM_CH5, PWM_CH6 ,PWM_CH7 ,PWM_CH8};
...
void main(void)
{
    ...
    pwm_init(PWM_CH5, 17000, 0);               	// 初始化 PWM 通道 频率 17KHz 初始占空比 0%
    pwm_init(PWM_CH6, 17000, 0);               	// 初始化 PWM 通道 频率 17KHz 初始占空比 0%
    pwm_init(PWM_CH7, 17000, 0);               	// 初始化 PWM 通道 频率 17KHz 初始占空比 0%
    pwm_init(PWM_CH8, 17000, 0);               	// 初始化 PWM 通道 频率 17KHz 初始占空比 0%
