...
typedef enum
{
    ...
    SPI2_CH1_SCLK_P67 = 0x2000 | IO_P67,
    SPI2_CH1_MOSI_P65 = 0x2000 | IO_P65,
    SPI2_CH1_MISO_P66 = 0x2000 | IO_P66,
    
    // SPI_2 只能使用同一组引脚，不允许混用引脚
    SPI2_CH2_SCLK_P05 = 0x2100 | IO_P05,
    SPI2_CH2_MOSI_P03 = 0x2100 | IO_P03,
    SPI2_CH2_MISO_P04 = 0x2100 | IO_P04,
    
    // SPI_2 只能使用同一组引脚，不允许混用引脚
    SPI2_CH3_SCLK_PB4 = 0x2200 | IO_PB4,
    SPI2_CH3_MOSI_PB2 = 0x2200 | IO_PB2,
    SPI2_CH3_MISO_PB3 = 0x2200 | IO_PB3,
    
    // SPI_2 只能使用同一组引脚，不允许混用引脚
    SPI2_CH4_SCLK_P83 = 0x2300 | IO_P83,
    SPI2_CH4_MOSI_P81 = 0x2300 | IO_P81,
    SPI2_CH4_MISO_P82 = 0x2300 | IO_P82,
    // ---------------- SPI_2 ----------------//
    
    // ---------------- SPI_3 ----------------//
    // SPI_3 只能使用同一组引脚，不允许混用引脚
    SPI3_CH1_SCLK_P25 = 0x3000 | IO_P25,
    SPI3_CH1_MOSI_P23 = 0x3000 | IO_P23,
    SPI3_CH1_MISO_P24 = 0x3000 | IO_P24,
    
    // SPI_3 只能使用同一组引脚，不允许混用引脚
    SPI3_CH2_SCLK_P73 = 0x3100 | IO_P73,
    SPI3_CH2_MOSI_P71 = 0x3100 | IO_P71,
    SPI3_CH2_MISO_P72 = 0x3100 | IO_P72,
    
    // SPI_3 只能使用同一组引脚，不允许混用引脚
    SPI3_CH3_SCLK_P87 = 0x3200 | IO_P87,
    SPI3_CH3_MOSI_P85 = 0x3200 | IO_P85,
    SPI3_CH3_MISO_P86 = 0x3200 | IO_P86,
    
    // SPI_3 只能使用同一组引脚，不允许混用引脚
    SPI3_CH4_SCLK_P93 = 0x3300 | IO_P93,
    SPI3_CH4_MOSI_P91 = 0x3300 | IO_P91,
    SPI3_CH4_MISO_P92 = 0x3300 | IO_P92,
    // ---------------- SPI_3 ----------------//
